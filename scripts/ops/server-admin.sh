...
usage() {
  cat <<USAGE
Usage:
  ./scripts/ops/server-admin.sh search-users --query <text>
  ./scripts/ops/server-admin.sh set-owner --server-id <id> --username <username>
  ./scripts/ops/server-admin.sh set-admin --server-id <id> --username <username> --enabled <true|false>
