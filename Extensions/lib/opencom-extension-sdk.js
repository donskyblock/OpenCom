...
export function createOpenComApiClient({ coreBaseUrl, nodeBaseUrl, authToken }) {
  ...
  client.nodeGuilds = {
    ...
    emotes: (guildId) => client.node.get(`/v1/guilds/${guildId}/emotes`),
    createEmote: (guildId, payload) => client.node.post(`/v1/guilds/${guildId}/emotes`, payload),
    deleteEmote: (guildId, emoteId) => client.node.del(`/v1/guilds/${guildId}/emotes/${emoteId}`),
