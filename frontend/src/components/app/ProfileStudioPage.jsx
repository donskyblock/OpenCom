    ...
    <div className="profile-studio profile-studio-full-page">
      <section className="profile-studio-layout">
        <aside className="card profile-studio-panel">
          ...
          {!hasBoostForFullProfiles && (
            <p className="hint">Boost is required to save custom layouts.</p>
          )}
        </aside>
        ...
        <section className="card profile-studio-canvas-wrap">
          ...
          >
            <div
              ...
              style={{
                background:
                  fullProfileDraft?.theme?.card || "rgba(9, 14, 28, 0.62)",
              }}
            >
        ...
        <aside className="card profile-studio-panel">
          ...
          {selectedProfileStudioElement ? (
            <>
              <p className="hint">
                Editing: <strong>{selectedProfileStudioElement.type}</strong>
              </p>
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    nudgeFullProfileElement(selectedProfileStudioElement.id, {
              ...
              <label>
                ...
                <input
                  ...
                  onChange={(event) =>
                    updateFullProfileElement(selectedProfileStudioElement.id, {
                ...
                <>
                  <label>
                    ...
                    {Math.max(
                      ...
                      Math.min(
                        72,
                        Number(selectedProfileStudioElement.fontSize ?? 16),
                      ),
                    )}
                    px)
                    <input
              ...
              <div className="row-actions">
                <button
                  ...
                  onClick={() =>
                    nudgeFullProfileElement(selectedProfileStudioElement.id, {
                      order:
                        Number(selectedProfileStudioElement.order || 0) + 1,
                    })
                  }
                >
                  Bring Forward
                ...
                <button
                  ...
                  className="danger"
                  onClick={() =>
                    removeFullProfileElement(selectedProfileStudioElement.id)
                  }
                >
                  Remove
                </button>
          ...
          <button type="button" className="ghost" onClick={addFullProfileLink}>
            Add Link
          </button>
          ...
          <label>
            ...
            {Math.max(
              0,
              Math.min(100, Number(fullProfileDraft?.music?.volume ?? 60)),
            )}
            %)
            <input
              type="range"
